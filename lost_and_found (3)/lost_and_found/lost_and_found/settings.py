...
# Uploaded item photos are saved here, inside the same data/ folder
# that already holds lost_found.csv and lost_found.json.
MEDIA_URL = "/media/"
...
SECRET_KEY = 'django-insecure-)2hzdgm38^ci)i7b#t_qdu^q=9jpbx*o-x3u#q^8bf$oq$m8(t'
